...
correct_event_jsons.append({"userId": "ab132","events": [{"eventName": "login","metadata": {},"timestampUTC": 10}]})
# one event with eventName and metadata, without timestampUTC
correct_event_jsons.append({"userId": "ab132","events": [{"eventName": "logout","metadata": {"os":"linux"}}]})
# two events with eventName only
correct_event_jsons.append({"userId": "ab132","events": [{"eventName": "login"}, {"eventName": "logout"}]})
wrong_events_jsons = []
# wrong events type
wrong_events_jsons.append({"userId": "ab132", "events": {"eventName":"login"}})
# wrong userId type
wrong_events_jsons.append({"userId": 123, "events": [{"eventName": "login","metadata": {},"timestampUTC": 10}]})
# misspelled field eventName -> events_name
wrong_events_jsons.append({"userId": "ab132","events": [{"events_name": "login","metadata": {},"timestampUTC": 10}]})
...
correct_alias_jsons.append({"newUserId": "abb1211", "originalUserId": "ab132", "timestampUTC": 10})
# all parameters without timestampUTC
correct_alias_jsons.append({"newUserId": "abb1211", "originalUserId": "ab132"})

wrong_alias_jsons = []
# wrong userId type
wrong_alias_jsons.append({"newUserId": 123, "originalUserId": "ab132", "timestampUTC": 10})
# wrong timestampUTC type
wrong_alias_jsons.append({"newUserId": "abb1311", "originalUserId": "ab132", "timestampUTC": "10"})
...
# all parameters correct
correct_profile_jsons.append({"userId": "new_user_id", "attributes": {"name":"Pavel", "location":"Lisbon"}, "timestampUTC": 0})

wrong_profile_jsons = []
# wrong attributes type
wrong_profile_jsons.append({"userId": "new_user_id", "attributes": [{"name":"Pavel", "location":"Lisbon"}], "timestampUTC": 0})
# misspeled attributes name
wrong_profile_jsons.append({"userId": "new_user_id", "att": {"name":"Pavel", "location":"Lisbon"}})
